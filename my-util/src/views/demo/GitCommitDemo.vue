<template>
  <div id="markdown-body-wrap" class="markdown-body">
    <h1 id="toc_0">Git提交规范</h1>

    <h2 id="toc_5">细则</h2>

    <p>
      在添加提交文件的时候，请勿使用<code>git add .</code>或者<code>git add -A</code
      >命令，应避免全部提交，提交文件应与本次提交内容相关，在提交之前应确定哪些文件需要提交：
    </p>

    <pre class="line-numbers"><code class="language-bash"># 使用status参数打印修改内容
git status
</code></pre>

    <p>然后通过<code>git add 文件路径</code>的方式提交</p>

    <pre class="line-numbers"><code class="language-bash">Jias  git-demo   master ●  git status
On branch master
...
no changes added to commit (use &quot;git add&quot; and/or &quot;git commit -a&quot;)
    ...
    <pre class="line-numbers"><code class="language-bash">git add README.md
</code></pre>

    <p>
      接下来在<code>commit</code>操作中添加提交信息，提交信息应包含<code>提交类型</code>、<code>模块</code>、<code>功能名称</code>、<code>提交内容简述</code>，并且用<code>|</code>隔开
    </p>

    <p><code>commit</code>类型选项包括以下：</p>

    <ul>
      <li><code>feat</code> 新功能</li>
      <li><code>fix</code> Bug 修复</li>
      <li><code>docs</code> 文档更新</li>
      <li><code>style</code> 代码的格式，标点符号的更新</li>
      <li><code>refactor</code> 代码重构</li>
      <li><code>perf</code> 性能优化</li>
      <li><code>test</code> 测试更新</li>
      <li><code>build</code> 构建系统或者包依赖更新</li>
      <li><code>ci</code> CI 配置，脚本文件等更新</li>
      <li><code>chore</code> 非 src 或者 测试文件的更新</li>
      <li><code>revert</code> commit 回退</li>
    </ul>

    <p>最后</p>

    <pre class="line-numbers"><code class="language-bash">git push
</code></pre>
    ...
    <p>假如本次提交包含多个功能模块或者多个业务，应分开提交，如：</p>

    <pre class="line-numbers"><code class="language-bash"># 提交模块1
...
git push
    ...
    <pre class="line-numbers"><code class="language-bash">feat(模块名): 更新内容简述
